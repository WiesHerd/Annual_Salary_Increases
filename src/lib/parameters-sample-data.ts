    ...
    appCombinedGroups: [
      {
        ...
        notes: 'Example roster: Mental Health Therapist, Licensed Professional Counselor',
      },
      {
        id: 'cg-mht-int',
        combinedGroupName: 'MHT Integrated care',
        surveySpecialties: ['Integrated Behavioral Health'],
        notes: 'Example roster: Integrated Behavioral Health',
      },
    ],
  },
};
