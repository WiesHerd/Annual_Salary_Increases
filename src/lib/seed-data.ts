 ...
 *
 * Current TCC is not stored here: it is derived on load from TCC components + Parameters → Current TCC checklist.
 * Component dollars are chosen so the derived sum matches each demo’s intended total cash where possible.
 */
...
export function getSeedProviderRecords(): ProviderRecord[] {
  return [
    ...
    },
    {
      ...
      WRVU_Percentile: 48,
      Prior_Year_WRVU_Incentive: 56000,
    ...
    // ─── Edge-case providers for testing ────────────────────────────────────
    {
      ...
      WRVU_Percentile: 52,
      Prior_Year_WRVU_Incentive: 15000,
    ...
    },
    {
      ...
      WRVU_Percentile: 42,
      Prior_Year_WRVU_Incentive: 16000,
      Years_of_Experience: 4,
      Evaluation_Score: 4,
      Default_Increase_Percent: 3.5,
      Applied_Increase_Percent: 3.5,
