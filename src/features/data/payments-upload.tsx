...
export function PaymentsUpload({ onUpload }: PaymentsUploadProps) {
  ...
  const [lastResult, setLastResult] = useState<PaymentUploadResult | null>(null);
    ...
    <div className="bg-white rounded-2xl border border-indigo-100 p-5 shadow-[0_4px_6px_-1px_rgba(79,70,229,0.07),0_2px_4px_-2px_rgba(79,70,229,0.07)]">
      ...
      <div className="flex flex-wrap gap-4 items-end mb-4">
        ...
        <button
          type="button"
          onClick={applyUpload}
          disabled={!file || !mapping.amount || !mapping.date}
